...
var UsersControler = /** @class */ (function () {
    ...
    UsersControler.prototype.get = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection_1.default('users').select('users.*')];
                    case 1:
                        users = _a.sent();
    ...
    UsersControler.prototype.post = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UsersControler.prototype.filter = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data_inicio, data_final, users;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, data_inicio = _a.data_inicio, data_final = _a.data_final;
                        return [4 /*yield*/, connection_1.default('users').where('checkIn', '>=', data_inicio)
    ...
    UsersControler.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, connection_1.default('users').where('id', "" + id).del()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, response.status(200).json({ status: 200, msg: 'Deletado com sucesso!' })];
                }
            });
        });
    };
...
exports.default = UsersControler;
